...
text/x-generic rsi4h.php ( PHP script, ASCII text, with CRLF line terminators )
<?php
...
try {
    ...
    $telegram = new \TelegramBot\Api\BotApi('5958429437:AAHgeovUAMZyAJUPuyYNGxj2bk7yKFvsYXU');
    ...
    foreach ($symbol_list as $symbol) {
        ...
        try {
            ...
            if (count($rsi_list) === 4 && $rsi_list[0] !== 0 && $rsi_list[1] !== 0 && $rsi_list[2] !== 0 && $rsi_list[3] !== 0) {
                if ($rsi_list[0] < 30 && $rsi_list[1] < 30 && $rsi_list[2] < 30 && $rsi_list[3] < 30) {
                    echo "$symbol: Oversold\n";
                    $message .= "<b>" . $symbol . ": Oversold" . "</b>";
                    $message.=chr(10);
                } elseif ($rsi_list[0] > 70 && $rsi_list[1] > 70 && $rsi_list[2] > 70 && $rsi_list[3] > 70) {
